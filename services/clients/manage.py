...
from project.api.models import Cliente  # <-- nuevo
...
def seed_db():
    """Seeds the database."""
    db.session.add(Cliente(nombre='fredy', apellidos='pongo claros', dni='38883848', sexo='M', celular='678788898', email="abelthf@gmail.com"))
    db.session.add(Cliente(nombre='fredy', apellidos='pongo claros', dni='38883848', sexo='M', celular='678788898', email="abelthf@gmail.com"))
    db.session.commit()
